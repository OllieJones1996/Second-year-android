...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGameView.setReturnButton((Button)findViewById(R.id.button4));
        */
        ...
        if(savedInstanceState == null){
            ...
            flag = (boolean) savedInstanceState.getSerializable("flag");
        }
        ...
        super.onCreate(savedInstanceState); //load saved data from previous time open
